...
후보를 실제로 변경할 때는 [의존성 호환성 검증 템플릿](DEPENDENCY_COMPATIBILITY_VALIDATION_TEMPLATE.md)의 사전 조건·후보별 회귀 흐름·롤백 기준을 사용합니다. 이 템플릿은 패치를 승인하거나 이미 통과한 것으로 주장하는 문서가 아니라, 한 후보씩 검증하기 위한 기록 형식입니다.
