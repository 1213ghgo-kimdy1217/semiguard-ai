...
type LoadingCopy = { title: string; description: string; slowDescription: string; retry: string; login: string; context: string };

const dashboardLoadingCopy: Record<LoadingLanguage, LoadingCopy> = {
  ko: { title: "SemiGuard AI 대시보드를 준비하고 있습니다.", description: "대시보드 데이터를 불러오는 중입니다…", slowDescription: "로딩이 평소보다 오래 걸리고 있습니다. 계속되면 새로고침해 주세요.", retry: "지금 새로고침", login: "로그인 화면으로 이동", context: "반도체 장비 예지안전 시스템" },
  en: { title: "Preparing the SemiGuard AI dashboard…", description: "Loading dashboard data…", slowDescription: "Loading is taking longer than usual. Refresh if it continues.", retry: "Refresh now", login: "Go to login", context: "Semiconductor equipment predictive safety system" },
  ja: { title: "SemiGuard AIダッシュボードを準備しています。", description: "ダッシュボードのデータを読み込み中です…", slowDescription: "読み込みに通常より時間がかかっています。続く場合は更新してください。", retry: "今すぐ更新", login: "ログイン画面へ", context: "半導体装置の予知安全システム" },
};

const authLoadingCopy: Record<LoadingLanguage, LoadingCopy> = {
  ko: { title: "보안 로그인 상태를 확인하고 있습니다.", description: "세션 정보를 안전하게 불러오는 중입니다…", slowDescription: "확인이 평소보다 오래 걸리고 있습니다. 계속되면 새로고침하거나 로그인 화면으로 이동해 주세요.", retry: "지금 새로고침", login: "로그인 화면으로 이동", context: "반도체 장비 예지안전 시스템" },
  en: { title: "Verifying your secure sign-in…", description: "Loading your session safely…", slowDescription: "Verification is taking longer than usual. Refresh or go to the login page.", retry: "Refresh now", login: "Go to login", context: "Semiconductor equipment predictive safety system" },
  ja: { title: "安全なログイン状態を確認しています。", description: "セッション情報を安全に読み込み中です…", slowDescription: "確認に通常より時間がかかっています。更新するか、ログイン画面へ移動してください。", retry: "今すぐ更新", login: "ログイン画面へ", context: "半導体装置の予知安全システム" },
};
