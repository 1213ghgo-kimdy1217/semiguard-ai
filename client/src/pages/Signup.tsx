...
const SIGNUP_COPY = {
  ko: {
    pageTitle: "SemiGuard AI | 센서 판단 훈련 회원가입",
    pageDescription: "SemiGuard AI의 가상 센서 판단 훈련과 점검 보조 화면을 사용할 계정을 등록합니다. 실제 설비 제어는 지원하지 않습니다.",
  ...
  en: {
    pageTitle: "SemiGuard AI | Sensor reasoning training sign up",
    pageDescription: "Create an account for SemiGuard AI's synthetic sensor reasoning practice and inspection aid. It does not control real equipment.",
  ...
  ja: {
    pageTitle: "SemiGuard AI | 信号判断訓練のアカウント登録",
    pageDescription: "SemiGuard AIの仮想センサー信号を使った判断訓練・点検支援のアカウントを登録します。実際の装置は制御しません。",
