...
export default function Training() {
  ...
  return <div className="tr-app"><a className="tr-skip" href="#training-main">훈련 내용으로 이동</a>
    <header className="tr-header"><Link href="/training" className="tr-brand" onClick={() => setStage("home")}><span>SG</span> SemiGuard <small>TRAINING LAB</small></Link><nav aria-label="훈련 메뉴"><button onClick={() => setStage("home")}>훈련 홈</button><Link href="/dashboard">기존 대시보드</Link><Link href="/welcome">소개</Link></nav></header>
