...
describe("live observation integration", () => {
  it("keeps the protected legacy dashboard and exposes independent public observation", () => {
    const app = readFileSync("client/src/App.tsx", "utf8");
    expect(app).toContain('path={"/dashboard"}');
    expect(app).toContain('path={"/dashboard/legacy"}');
    ...
    expect(page).toContain('href="/dashboard">{l("4센서 대시보드"');
  });
